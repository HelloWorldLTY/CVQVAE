...
def get_cell_cycle_conservation(adata_solution):
    ...
    print('Compute score')
    adata = sc.AnnData(adata_solution.obsm['X_emb']) 
    ...
    adata_solution.obsm['X_emb'] = adata_solution.obsm['embeddings']
...
def get_traj_conservation(adata_solution):
    ...
    sc.pp.neighbors(adata_solution, use_rep='embeddings')
...
adata.obsm['X_emb'] = ema_data
adata.obsm['embeddings'] = np.vstacl([adata_atac.obsm['lsi_full'], adata_gex.obsm['X_pca']])
